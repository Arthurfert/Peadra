...
class PeadraTheme {
  ...
  static final Map<String, PeadraColors> themes = {
    'light': const PeadraColors(
      ...
      textSecondary: Color(0xFF394659),
    ...
    'dark': const PeadraColors(
      ...
      textSecondary: Color(0xFFADB9C9),
      accent: Color(0xFF2C6FDA),
      success: Color(0xFF10B981),
      warning: Color(0xFFF59E0B),
      error: Color(0xFFEF4444),
      info: Color(0xFF3B82F6),
    ...
    'autumn': const PeadraColors(
      ...
      textSecondary: Color(0xFFD2C5C1),
    ...
    'spring': const PeadraColors(
      ...
      textSecondary: Color(0xFF2A4C26),
    ...
    'summer': const PeadraColors(
      ...
      textSecondary: Color(0xFF1C3859),
